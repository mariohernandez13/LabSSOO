...
int main() {
    ...
    char num_pthread[MAX_LINE_LENGTH] = "";
    char num_files[MAX_LINE_LENGTH] = "";
    ...
    while (fgets(line, MAX_LINE_LENGTH, file)) {
        ...
        if (key && value) {
            if (strcmp(key, "username") == 0) {
                ...
                strncpy(num_files, value, MAX_LINE_LENGTH);
            }
            else if (strcmp(key, "num_pthread") == 0){
                strncpy(num_pthread, value, MAX_LINE_LENGTH);
            }
        }
    }
